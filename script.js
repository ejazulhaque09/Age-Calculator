...
function getDOB(){
    let data = document.getElementById("inputDOB").ariaValueMax;

    // conver input data to usable format
    // as day month year
    ...
    let now = new Date(document.getElementById("currentDate").value)
    console.log(now);
    ...
    function currentDate() {
        ...
        let d = document.getElementById("currentDate");
        d.value = formatted();
    }
